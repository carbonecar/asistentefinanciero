...
\title{Sistema Multi-Agente para la Gestión y Optimización de Carteras de Inversión en Renta Fija y Variable}

\author[1]{José Carlos Carbone}
\author[1]{MARCO SEBASTIAN PADILLA}
...
En el caso de las Obligaciones Negociables, el sistema prioriza el cálculo de la Tasa Interna de Retorno (TIR) y la \textit{Duration} para mitigar el riesgo de tasa de interés.
